...
def generate_variety_showcase(count: int = 100) -> None:
    ...
    print("=" * 60)
    print()
    print("View them in: output/variety/")
    print("Each one is unique with different:")
    print("  - Gradient colors (organic paths)")
    print("  - Gradient type (aurora/plasma/wave/radial)")
    print("  - Loop type (epitrochoid/lissajous/rose)")
    print("  - Loop parameters (frequencies/petals/radii)")
    print("  - Position & size")
