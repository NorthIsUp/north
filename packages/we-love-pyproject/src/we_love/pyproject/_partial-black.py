...
class Model(BaseModel):
    ...
    code: str | None = Field(None, description="Format the code passed in as a string.")
    line_length: int | None = Field(88, alias="line-length", description="How many characters per line to allow.")
