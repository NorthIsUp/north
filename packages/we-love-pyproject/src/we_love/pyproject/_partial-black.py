...
#   filename:  https://json.schemastore.org/partial-black.json
#   timestamp: 2025-10-07T20:59:17+00:00
...
class Model(BaseModel):
    ...
    code: Optional[str] = Field(None, description="Format the code passed in as a string.")
    line_length: Optional[int] = Field(88, alias="line-length", description="How many characters per line to allow.")
    target_version: Optional[List[TargetVersionEnum]] = Field(
        None,
    ...
    python_cell_magics: Optional[List[str]] = Field(
        None,
    ...
    skip_source_first_line: Optional[bool] = Field(
        False,
    ...
    enable_unstable_feature: Optional[List[str]] = Field(
        None,
    ...
    extend_exclude: Optional[str] = Field(
        None,
    ...
    force_exclude: Optional[str] = Field(
        None,
        alias="force-exclude",
